...
public class Class_PopUp extends PopupWindow {
    ...
    public Class_PopUp(final Activity mcontext, View.OnClickListener itemClickListener, NumberPicker.OnValueChangeListener onValueChangeListener) {
