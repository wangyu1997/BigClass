...
public class Place_PopUp extends PopupWindow {
    ...
    public Place_PopUp(final Activity mcontext, View.OnClickListener itemClickListener, NumberPicker.OnValueChangeListener onValueChangeListener) {
        mMenuView = LayoutInflater.from(mcontext).inflate(R.layout.week_popup, null);
        data = mcontext.getResources().getStringArray(R.array.place);
